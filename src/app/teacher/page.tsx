      ...
      <div className="flex gap-6 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="mx-auto max-w-6xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
            {/* 1. ActionCard (placeholder) */}
            <section>
              <div className="rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-4 text-lg font-semibold text-slate-900">Action Card</h2>
                <div className="flex h-32 items-center justify-center rounded-lg bg-slate-100 text-slate-500">
                  {/* TODO: Replace with ActionCard component */}
                  <p>ActionCard component — classId={CLASS_ID}, subject={classData.subject}</p>
                </div>
              </div>
            </section>
            ...
            <section>
              <div className="mb-4 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {language === 'en' ? 'By Difficulty' : 'Mengikut Kesukaran'}
                  </button>
                  <button
                  ...
                  >
                    {language === 'en' ? 'By Topic' : 'Mengikut Topik'}
                  </button>
                </div>
              </div>

              <div className="rounded-lg bg-white p-6 shadow-sm">
                <div className="flex h-80 items-center justify-center rounded-lg bg-slate-100 text-slate-500">
                  {/* TODO: Replace with ClassGapMap component */}
                  <p>ClassGapMap heatmap grid (click a cell to view student details)</p>
                </div>
              </div>
            </section>
